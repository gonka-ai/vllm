...
class SamplingParams(
    ...
    to use the deployment-level default."""
    ...
    """Enforced next-token IDs for Gonka validation replay. When set, sampling
    computes logprobs from the model distribution but emits this sequence."""
