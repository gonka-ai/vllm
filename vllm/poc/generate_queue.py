...
from .callbacks import clear_callback_queue, get_callback_queue
from .data import DEFAULT_DIST_THRESHOLD, DEFAULT_FRAUD_THRESHOLD, DEFAULT_P_MISMATCH
from .validation import run_validation

logger = init_logger(__name__)

POC_GENERATE_CHUNK_TIMEOUT_SEC = float(
    os.environ.get("POC_GENERATE_CHUNK_TIMEOUT_SEC", "60")
)
POC_CHAT_BUSY_BACKOFF_SEC = 0.05
POC_GENERATE_RESULT_TTL_SEC = float(
    os.environ.get("POC_GENERATE_RESULT_TTL_SEC", "300")
)
